...
</script>	<noscript><meta http-equiv="refresh" content="0; URL=/files/pranav.vashistha/F4D1VMUQK/background-worker.js?nojsmode=1" /></noscript>
...
<script>(function() {
	...
	<script type="text/javascript">
		...
		sb('set', 'token', '3307f436963e02d4f9eb85ce5159744c');
					...
					sb('set', 'user_id', "U3HR6MJ4B");
							sb('set', 'user_' + "batch", "signup_api");
							sb('set', 'user_' + "created", "2016-12-21");
						sb('set', 'name_tag', "feeljoy" + '/' + "puranjayjain");
				sb('track', 'pageview');
...
<script>TSSSB.env = (function() {
	...
	<script type="text/javascript">
	    ...
	    <title>background-worker.js | FeelJoy Slack</title>
    <meta name="author" content="Slack">
			...
			<!-- output_css "core" -->
    <link href="https://a.slack-edge.com/334e/style/rollup-plastic.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">
    ...
    <link href="https://a.slack-edge.com/553b2/style/codemirror_overrides.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">

	<!-- output_css "file_pages" -->
    <link href="https://a.slack-edge.com/d503b/style/rollup-file_pages.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">

		<!-- output_css "regular" -->
    <link href="https://a.slack-edge.com/d1ad8/style/print.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">
    ...
    <link href="https://a.slack-edge.com/eefc4/style/react_emoji_picker_overrides.css" rel="stylesheet" type="text/css" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)">
	...
	<div id="site_nav_contents">
		...
		<div id="user_menu">
			<div id="user_menu_contents">
				<div id="user_menu_avatar">
										<span class="member_image thumb_48" style="background-image: url('https://avatars.slack-edge.com/2017-01-10/126068850199_492f0f7d5d7acd3ffb4f_192.png')" data-thumb-size="48" data-member-id="U3HR6MJ4B"></span>
					<span class="member_image thumb_36" style="background-image: url('https://avatars.slack-edge.com/2017-01-10/126068850199_492f0f7d5d7acd3ffb4f_72.png')" data-thumb-size="36" data-member-id="U3HR6MJ4B"></span>
				</div>
				<h3>Signed in as</h3>
				<span id="user_menu_name">puranjayjain</span>
			</div>
		</div>
		...
		<div id="footer">
			...
			<ul id="footer_nav">
				...
				<li><a href="https://slack.com/signout/71280301781?crumb=s-1488511048-3223e47239-%E2%98%83" data-qa="sign_out">Sign Out<i class="ts_icon ts_icon_sign_out small_left_margin ts_icon_inherit"></i></a></li>
			</ul>
					...
					<span class="block label">Help</span>
						...
						<span class="block label">Launch</span>
				                    ...
				                    <ul id="header_team_nav" data-qa="team_switcher_menu">
	                        	                            <li class="active">
	                            	<a href="https://feeljoy.slack.com/home" target="https://feeljoy.slack.com/">
	                            			                            			<i class="ts_icon small ts_icon_check_circle_o active_icon s"></i>
	                            			                            				                            		<i class="team_icon small" style="background-image: url('https://s3-us-west-2.amazonaws.com/slack-files2/avatars/2017-01-15/127053377281_c2efc2730603d1be02a7_88.jpg');"></i>
		                            		                            		<span class="switcher_label team_name">FeelJoy</span>
	                            	</a>
	                            </li>
...
<p class="print_only">
	...
	Created by pranav.vashistha on Friday, March 3, 2017 at  8:33 AM
	</strong><br />
	<span class="subtle_silver break_word">https://feeljoy.slack.com/files/pranav.vashistha/F4D1VMUQK/background-worker.js</span>
</p>
...
<div class="file_public_link_shared alert" style="display: none;">
	...
	<i class="ts_icon ts_icon_link"></i> Public Link: <a class="file_public_link" href="https://slack-files.com/T23888VNZ-F4D1VMUQK-6a707a1a0d" target="new">https://slack-files.com/T23888VNZ-F4D1VMUQK-6a707a1a0d</a>
</div></div>
...
<div id="file_page" class="card top_padding">
	...
	<p class="small subtle_silver no_print meta">
		...
		98b JavaScript/JSON snippet created on <span class="date">March 3, 2017</span>.
	...
	<div class="large_bottom_margin clearfix">
		<pre id="file_contents">var version = 2;
importScripts(&#039;https://cdn.pushcrew.com/sw/2af3528e08af3f47d8eedf0b5be2ac28.js&#039;);</pre>
...
<form action="https://feeljoy.slack.com/files/pranav.vashistha/F4D1VMUQK/background-worker.js"
		id="file_comment_form"
					class="comment_form clearfix"
				method="post">
			<a href="/team/puranjayjain" class="member_preview_link" data-member-id="U3HR6MJ4B" >
			<span class="member_image thumb_36" style="background-image: url('https://avatars.slack-edge.com/2017-01-10/126068850199_492f0f7d5d7acd3ffb4f_72.png')" data-thumb-size="36" data-member-id="U3HR6MJ4B"></span>
		</a>
		<input type="hidden" name="addcomment" value="1" />
	<input type="hidden" name="crumb" value="s-1488511048-b79b253d10-☃" />
...
<script type="text/javascript">
	 ...
	 * @param {Array} [locales] - An optional array of locale IETF tags (en-US, fr-FR, etc)
	 * @returns {String}
	 */
	function vvv(filePath, locales) {
		...
		if (locales && locales.indexOf(TS.i18n.locale()) > -1 && TS.i18n.locale() !== TS.i18n.DEFAULT_LOCALE) {
			filePath = filePath.replace(/(\..+$)/, '.' + TS.i18n.locale() + '$1');
		}
		return filePath;
	}
...
<!--
	...
	var boot_data = {
		...
		user_id: 'U3HR6MJ4B',
		no_login: false,
		version_ts: '1488508351',
		version_uid: '5351baef2f634b23ee655b44eec19b2aa53a9d3a',
		...
		feature_flannel_channel_counts: false,
		feature_deprecate_10_8: false,
		feature_thin_channel_membership: false,
		feature_batch_file_deleted_event: true,
		...
		feature_react_emoji_picker: true,
		feature_react_emoji_picker_on_webpages: true,
		...
		feature_auth_unfurls: false,
		feature_single_team_apps: true,
		...
		feature_thin_shares: true,
		feature_claim_email_domain: true,
		feature_a11y_ui_zoom: true,
		feature_message_menus: false,
		feature_sli_recaps: true,
		feature_sli_recaps_interface: false,
		feature_sli_recaps_arrows_and_markers: false,
		feature_searchable_member_list: true,
		feature_user_custom_status: false,
		feature_hide_join_leave: false,
		feature_ws_access: true,
...
//-->
	...
	<!-- output_js "core" -->
<script type="text/javascript" src="https://a.slack-edge.com/b7a7f/js/rollup-core_required_libs.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/402de/js/rollup-core_required_ts.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/d363/js/TS.web.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>

	<!-- output_js "core_web" -->
<script type="text/javascript" src="https://a.slack-edge.com/fae01/js/rollup-core_web.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>

	<!-- output_js "secondary" -->
<script type="text/javascript" src="https://a.slack-edge.com/cb4b1/js/rollup-secondary_a_required.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/5a424/js/rollup-secondary_b_required.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>

			
	<!-- output_js "regular" -->
<script type="text/javascript" src="https://a.slack-edge.com/d3e19/js/TS.web.comments.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
<script type="text/javascript" src="https://a.slack-edge.com/0b463/js/TS.web.file.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>
...
<script type="text/javascript" src="https://a.slack-edge.com/aa6d/js/codemirror_load.js" crossorigin="anonymous" onload="window._cdn && _cdn.ok(this, arguments)" onerror="window._cdn && _cdn.failed(this, arguments)"></script>


		<script type="text/javascript">
				TS.clog.setTeam('T23888VNZ');
				TS.clog.setUser('U3HR6MJ4B');
			</script>
	...
	<!--
		...
		boot_data.file = {"id":"F4D1VMUQK","created":1488510235,"timestamp":1488510235,"name":"background-worker.js","title":"background-worker.js","mimetype":"text\/plain","filetype":"javascript","pretty_type":"JavaScript\/JSON","user":"U236M4W3D","editable":true,"size":98,"mode":"snippet","is_external":false,"external_type":"","is_public":false,"public_url_shared":false,"display_as_bot":false,"username":"","url_private":"https:\/\/files.slack.com\/files-pri\/T23888VNZ-F4D1VMUQK\/background-worker.js","url_private_download":"https:\/\/files.slack.com\/files-pri\/T23888VNZ-F4D1VMUQK\/download\/background-worker.js","permalink":"https:\/\/feeljoy.slack.com\/files\/pranav.vashistha\/F4D1VMUQK\/background-worker.js","permalink_public":"https:\/\/slack-files.com\/T23888VNZ-F4D1VMUQK-6a707a1a0d","edit_link":"https:\/\/feeljoy.slack.com\/files\/pranav.vashistha\/F4D1VMUQK\/background-worker.js\/edit","preview":"var version = 2;\nimportScripts('https:\/\/cdn.pushcrew.com\/sw\/2af3528e08af3f47d8eedf0b5be2ac28.js');","preview_highlight":"\u003Cdiv class=\"CodeMirror cm-s-default CodeMirrorServer\" oncopy=\"if(event.clipboardData){event.clipboardData.setData('text\/plain',window.getSelection().toString().replace(\/\\u200b\/g,''));event.preventDefault();event.stopPropagation();}\"\u003E\n\u003Cdiv class=\"CodeMirror-code\"\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Evar\u003C\/span\u003E \u003Cspan class=\"cm-def\"\u003Eversion\u003C\/span\u003E \u003Cspan class=\"cm-operator\"\u003E=\u003C\/span\u003E \u003Cspan class=\"cm-number\"\u003E2\u003C\/span\u003E;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-variable\"\u003EimportScripts\u003C\/span\u003E(\u003Cspan class=\"cm-string\"\u003E'https:\/\/cdn.pushcrew.com\/sw\/2af3528e08af3f47d8eedf0b5be2ac28.js'\u003C\/span\u003E);\u003C\/pre\u003E\u003C\/div\u003E\n\u003C\/div\u003E\n\u003C\/div\u003E\n","lines":2,"lines_more":0,"preview_is_truncated":false,"channels":[],"groups":[],"ims":["D3HR6MKPD"],"comments_count":0};
...
<!-- slack-www-hhvm-0ffc69c7f07f581b4 / 2017-03-02 19:17:28 / v5351baef2f634b23ee655b44eec19b2aa53a9d3a / B:H -->
