		...
		return this.each(function(){
			...
			for(var n = 0; n < buttons.length; n++)
			{
				...
				if(vars[buttons[n].name])
				{
					...
					toolbar.append('<div class="'+vars.css+'_tool '+vars.css+'_tool_'+buttons[n].cls+'" role="button" data-tool="'+n+'" unselectable><a class="'+vars.css+'_tool_icon" unselectable href="javascript:void(0);"></a></div>');
					...
					if(buttons[n].name=="format" && $.isArray(vars.formats))
					{
						...
						toolbar.find("."+vars.css+'_tool_'+buttons[n].cls).find("."+vars.css+"_tool_icon").replaceWith('<a class="'+vars.css+'_tool_label" unselectable href="javascript:void(0);"><span class="'+vars.css+'_tool_text" unselectable>'+toolLabel+'</span><span class="'+vars.css+'_tool_icon" unselectable></span></a>');
						...
						{
							toolbar.find("."+vars.css+"_formats").append('<a href="javascript:void(0);" '+vars.css+'-formatval="'+ vars.formats[f][0] +'" class="'+vars.css+'_format'+' '+vars.css+'_format_'+f+'" role="menuitem" unselectable>'+ vars.formats[f][1] +'</a>');
						}
					...
					else if(buttons[n].name=="fsize" && $.isArray(vars.fsizes))
					{
						...
						{
							toolbar.find("."+vars.css+"_fontsizes").append('<a href="javascript:void(0);" '+vars.css+'-styleval="'+ vars.fsizes[f] +'" class="'+vars.css+'_fontsize'+'" style="font-size:'+ vars.fsizes[f]  + vars.funit+'" role="menuitem" unselectable>Abcdefgh...</a>');
						}
					}
					...
					else if(buttons[n].name=="color" && $.isArray(colors))
					{
						...
						{
							if(colors[c]!=null)
								toolbar.find("."+vars.css+"_cpalette").append('<a href="javascript:void(0);" '+vars.css+'-styleval="'+ colors[c] +'" class="'+vars.css+'_color'+'" style="background-color: rgb('+ colors[c] +')" role="gridcell" unselectable></a>');
							else
