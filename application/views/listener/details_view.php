...
<body>
 ...
 <div class="wrapper-profile">
      ...
      <img src="<?php echo base_url();?>pics_listener/<?php echo $listener['profile_img']?>" class="img-responsive proimg-sty">
	  <div class="pro-text">
	  <h1 class="text-center"><?php echo $listener['name'];?></h1>
 <p class="text-center" style="color:#fff;width:100%;margin-bottom:2.5rem;font-size:1em;"><?php echo $listener['qualification'];?></p>
 </div>
 </div>
...
<div class="send-mesg text-center" style="cursor: pointer;"><i class="ion-chatbubble-working"></i>  &nbsp;Send Message</div></a>	   </div>
