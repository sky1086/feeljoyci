...
<link rel="shortcut icon" sizes="196x196"
	href="img/touch/touch-icon-196x196.png">
...
<link href='https://fonts.googleapis.com/css?family=Roboto:400,700,100'
	rel='stylesheet' type='text/css'>
...
<link rel="stylesheet" href="<?php echo base_url();?>css/desktop.css">
</head>
	...
	<div id="panel" style="height:100%;">
		<div id="main" class="main" style="height:100%;">
			...
			<div class="container-fluid" style="height:100%;">
				...
				<div class="desktop-wrapper" style="height: 100%;">
							...
							<div class="col-md-4 col-lg-4 col-sm-4 col-xs-12 col-md-offset-4" style="height: 100%;">
								<div class="mobile-bg">
									<div class="mobile-bg-in">
											<div class="content4">
											<iframe id="feelIframe" src="https://feeljoy.in/index.html" style="width:264px;height:423px;border:0;mrgin:0px;"></iframe>
