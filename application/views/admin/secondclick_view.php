 ...
 <div class="row">
     ...
     <div class="row">
     	<div class="col-md-10 col-lg-10 col-sm-10 col-xs-10" style="background-color: white; color:#000;">
              ...
              <div class="user-desc">
                <select name="theme" id="theme" style="width: 200px;" onchange="window.location='<?php echo base_url();?>admin/secondclick/index/'+this.value">
...
<!--
$('#themeedit').Tabledit({
	url: '<?php echo base_url();?>admin/secondclick/edit',
    deleteButton: false,
    autoFocus: false,
    buttons: {
        edit: {
...
function addTheme(){
	...
	$.ajax({
		type: 'post',
		url: '<?php echo base_url();?>admin/secondclick/add',
